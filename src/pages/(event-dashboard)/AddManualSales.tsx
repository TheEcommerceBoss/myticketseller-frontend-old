...
export default function AddManualSales() {
  ...
  const [manualSales, setManualSales] = useState<IManualSale[]>([]);
        ...
        <div className="space-y-6">
          <div>
            <div className="bg-[#0a0a80] text-white p-4 rounded-t-lg">
              <h2 className="text-xl font-medium">Offline Sales</h2>
            </div>
          ...
          <form className="space-y-6">
            <div>
              <div className="bg-[#0a0a80] text-white p-4 rounded-t-lg">
                <h2 className="text-xl font-medium">Buyer’s information</h2>
              </div>
              ...
              <div className="p-4 space-y-6 bg-white md:p-8">
                ...
                <div className="space-y-2 text-sm md:text-base">
                  ...
                  <p className="max-w-4xl">
                    Please always check the ticket quantity while adding
                    attendees ticket information. The information may not be
                    added for the following reasons:
                  </p>
                  <ol>
                    <li>{"1) Event is not active / ended"}</li>
                    <li>
                      {
