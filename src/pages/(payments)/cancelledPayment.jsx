                ...
                <>
                    ...
                    <div className="bg-black min-h-screen flex flex-col items-center justify-center">
                        <div className="bg-[#121212] max-w-2xl flex flex-col items-center justify-center p-[3rem] py-[5rem] rounded-2xl">
                            ...
                            <h5 className="text-center text-2xl mb-5 text-white">Payment Failed</h5>
                            <h5 className="text-center text-lg text-white">Kindly click the "X" icon at the top right of your screen to close this popup</h5>
