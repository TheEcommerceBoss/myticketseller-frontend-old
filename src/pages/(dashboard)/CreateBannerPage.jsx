...
const CreateBannerPage = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        setscannedrecords(response.data.scanned_records)
      } catch (error) {
  ...
  const scancolumns = [
    { field: 'id', headerName: '#', width: 50, sortable: false, hideSortIcons: true },
    { field: 'scanner_name', headerName: 'Scanned By', width: 250 },
    { field: 'reference_id', headerName: 'Ticket Code', width: 250 },
    { field: 'scanned_time', headerName: 'Scanned Time', width: 250 },
  ...
  const scannedrecordsWithIndex = scannedrecords.map((event, index) => ({
    ...event,
    id: index + 1,
  }));
