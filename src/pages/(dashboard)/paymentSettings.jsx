            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select className="w-full p-2 border border-[#040171] rounded-lg text-sm">
              ...
              <div>
                ...
                <input
                  type="text"
                  className="w-full p-2 border border-[#040171] rounded-lg text-sm"
                />
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-center">
                <div className="inline-flex rounded-full p-1 bg-gray-100">
                  <button
                    className={`px-6 py-2 rounded-full text-sm ${!isPaid ? 'bg-white shadow' : ''}`}
                    onClick={() => setIsPaid(false)}
                  >
                    Free
                  </button>
                  <button
                    className={`px-6 py-2 rounded-full text-sm ${isPaid ? 'bg-[#040171] text-white' : ''}`}
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-center items-center gap-4">
                  ...
                  <span className="w-12 text-center text-sm">{pricingCount}</span>
                  <button
                    onClick={() => handlePricingCountChange(1)}
                ...
                {[
                  ...
                  <div key={index} className="grid grid-cols-3 gap-4">
                    <input
                      ...
                      className="p-2 border border-[#040171] rounded-lg text-sm"
                    ...
                    <input
                      ...
                      placeholder="Price"
                    />
                    <select className="p-2 border border-[#040171] rounded-lg text-sm">
                      <option>Naira</option>
                    </select>
                  </div>
                ))}
