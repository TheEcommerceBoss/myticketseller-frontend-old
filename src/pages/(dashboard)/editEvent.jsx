...
const EditEvent = ({ manage }) => {
  ...
  const CreateEventHandler = async () => {
    ...
    try {
      ...
      navigate(
        "/dashboard/event/create/" + response.data.event_id + "/payments/ "
      );
    } catch (error) {
      if (error.response) {
