...
import { earningsApi, usersApi } from "../../shared/services/api";
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const withdrawEarningsResponse = await usersApi.getWithdrawals();
        setWithdrawEarnings(withdrawEarningsResponse.data);
        console.log(
          "my responses",
          referralEarningsResponse,
          withdrawEarningsResponse
        );
      } catch (error) {
