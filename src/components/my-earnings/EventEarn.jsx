...
import { earningsApi, eventsApi } from "../../shared/services/api";
...
export default function EventEarn() {
	...
	useEffect(() => {
		const fetchData = async () => {
			try {
				setLoading(true);
				const eventEarningsResponse =
					await earningsApi.getEventEarnings();
				setEventEarnings(eventEarningsResponse);
