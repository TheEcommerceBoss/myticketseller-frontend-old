...
import { MapPin, Menu, Moon, Search, Sun, X } from "lucide-react";
		...
		const getLocationData = async () => {
			try {
				...
				if (
					...
					console.log(`https://ipwhois.app/json/${ipAddress}`);
...
const HeaderMain = ({
	...
	return (
		...
		>
			<nav
				className={`flex items-center  ${variation === 1
					? "lg:mt-[2rem] lg:w-[80%] lg:rounded-full "
					: ""
						...
						<div className="hidden space-x-6 lg:flex">
							{variation === 1 || variation === 4 ? (
								<>
									...
									<Link
										to="/event/find"
										className={`hover:text-orange-500 text-lg ${locations.pathname.startsWith(
											"/event"
										)
											? "text-orange-600"
											: theme === "light"
								...
								<>
									<div className="hidden max-w-4xl px-4 mx-auto lg:flex">
										<form
											onSubmit={handleSearch}
											className="flex items-center overflow-hidden bg-white border border-gray-200 rounded-full shadow-lg"
										>
											<div className="flex items-center flex-1 divide-x divide-gray-200">
												...
												<div className="flex items-center flex-1 px-4 py-1">
													...
													<input
														...
														className="w-full text-lg text-gray-700 placeholder-gray-500 outline-none"
													/>
												</div>
												...
												<div className="flex items-center px-4 py-1">
													...
													<input
														...
														className="w-40 text-lg text-gray-700 placeholder-gray-500 outline-none"
													/>
												</div>
											</div>
											...
											<button
												...
												onClick={searchEvent}
												onSubmit={searchEvent}
												className="p-4 transition-colors bg-orange-500 hover:bg-orange-600"
											>
						...
						<div className="flex items-center px-3 space-x-4">
							{variation === 2 ? (
								<Link
									...
									to={"/"}
									className={`text-gray-700 hover:text-orange-500 text-lg ${theme === "light"
										? "text-gray-700"
										: "text-white"
										}`}
								>
							...
							<Link
								...
								className="items-center hidden gap-2 px-5 py-3 text-white transition duration-300 bg-orange-500 rounded-full lg:flex align-center hover:bg-orange-600"
							>
								{variation === 2 ? (
									<>
