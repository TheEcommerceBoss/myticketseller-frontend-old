        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap justify-between pb-3 mb-6 text-sm border-b gap-x-4 sm:text-base">
            ...
            <p className="text-gray-700">
              Account since{" "}
              <span className="text-[#040171]">Jul 20, 2024 09:33 AM</span>
            </p>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <StatCard
                icon={<Calendar className="w-6 h-6 text-[#040171]" />}
                count={eventsCreated}
                label="Events Created"
              />
              <StatCard
                icon={<User className="w-6 h-6 text-[#040171]" />}
                count="1"
              ...
              />
              <StatCard
                icon={<ThumbsUp className="w-6 h-6 text-[#040171]" />}
                count="+2"
                label="My Likes"
              />
              <StatCard
              ...
              />
              <StatCard
                icon={<FileText className="w-6 h-6 text-[#040171]" />}
                count={totalOrders}
                label="Your Total Order"
              />
              <StatCard
                icon={<Ticket className="w-6 h-6 text-[#040171]" />}
                count="+2"
                label="Tickets Sold"
              />
            </div>
